...
public class DiscoverPuller {
    ...
    public static void refreshTopicHot(int topicId, String firstItemTime) {
        Map<String, String> params = new HashMap<>();
        params.put(Config.PARAM_KEY_TOPIC_ID, String.valueOf(topicId));
        params.put(Config.PARAM_KEY_TIME_STAMP, String.valueOf(firstItemTime));
        doPull(Config.PAGE_ID_ACTIVITY_TOPIC, Config.PULL_TYPE_REFRESH, params);
    }

    public static void loadMoreTopicHot(int topicId, String lastItemTime) {
        Map<String, String> params = new HashMap<>();
        params.put(Config.PARAM_KEY_TOPIC_ID, String.valueOf(topicId));
        params.put(Config.PARAM_KEY_TIME_STAMP, String.valueOf(lastItemTime));
        doPull(Config.PAGE_ID_ACTIVITY_TOPIC, Config.PULL_TYPE_LOAD_MORE, params);
    }
    ...
    public static void refreshTopicLasted(int topicId, String firstItemTime) {
        ...
        params.put(Config.PARAM_KEY_TOPIC_ID, String.valueOf(topicId));
        params.put(Config.PARAM_KEY_TIME_STAMP, String.valueOf(firstItemTime));
        doPull(Config.PAGE_ID_DISCOVER_TOPIC, Config.PULL_TYPE_REFRESH, params);
    }
    ...
    public static void loadMoreTopicLasted(int topicId, String lastItemTime) {
        ...
        params.put(Config.PARAM_KEY_TOPIC_ID, String.valueOf(topicId));
        params.put(Config.PARAM_KEY_TIME_STAMP, String.valueOf(lastItemTime));
        doPull(Config.PAGE_ID_DISCOVER_TOPIC, Config.PULL_TYPE_LOAD_MORE, params);
    }
